...
namespace RobotSpeaker.Forms
{
    public partial class FaceUI : PageUIBase
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            btnGetPic.NoFocusImage = MainService.GetImage(Path.Combine(Application.StartupPath, @"Images\pic1.png"));
            btnGetPic.FocusImage = MainService.GetImage(Path.Combine(Application.StartupPath, @"Images\pic2.png"));

            btnRecord.NoFocusImage = MainService.GetImage(Path.Combine(Application.StartupPath, @"Images\video1.png"));
            btnRecord.FocusImage = MainService.GetImage(Path.Combine(Application.StartupPath, @"Images\video2.png"));
